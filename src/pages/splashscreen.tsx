...
const Splash = () => {
  ...
  return (
    <div className="container" id="home">
      ...
      <div className="text-gray-100 text-3xl font-semibold mt-[20rem] text-center w-[100%] absolute">
        WELCOME
      </div>
      ...
      <Link
        to="/login"
        className="w-[90%] py-4 text-center bottom-40 bg-[#7C9A92] mx-4 absolute mt-[30rem] text-gray-100 text-2xl rounded-xl"
      >
